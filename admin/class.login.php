...
class logmein {
	...
	var $database_logon = 'Operators';		//Database NAME
	var $username_logon = 'ccis_user';		//Database USERNAME
	var $password_logon = 'ccis_password_test';		//Database PASSWORD
	
	//table fields
	var $user_table = 'auth';			//Users table name
	...
	function loginform($formname, $formclass, $formaction){
		//conect to DB
		$this->dbconnect();
		echo'<div class="inner"><form name="'.$formname.'" method="post" id="'.$formname.'" class="'.$formclass.'" enctype="application/x-www-form-urlencoded" action="'.$formaction.'">
				...
				<input class="buttonLogin" name="submit" id="submit" value="Login" type="submit"><br>
			</form></div>';
	}
	//reset password form
